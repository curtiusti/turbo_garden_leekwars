...
class LeekWarsBot:
    ...
    def login(self):
        ...
        try:
            self.logger.info("Connexion à LeekWars...")
    ...
    def make_api_call(self, endpoint, params = None, method='POST'):
        ...
        self.logger.debug(f"Appel API {endpoint}")
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if self.login():
                    ...
                    return self.make_api_call(endpoint, method)
                return None
    ...
    def get_garden_farmer_opponents(self):
        ...
        result=self.make_api_call(endpoint=endpoint, method='GET')
    ...
    def get_garden_leek_opponents(self, leek_id):
        ...
        result = self.make_api_call(endpoint, method='GET')
